...
'''Trained referencing code from both the official paper https://github.com/descriptinc/melgan-neurips/ 
and the unofficial implementations https://github.com/kan-bayashi/ParallelWaveGAN
and help from GPT4'''
...
from layers import CausalConv1d, CausalConvTranspose1d, ResidualStack
